...
class SystemValidator:
    ...
    def validate_metrics_configurations(self) -> Dict[str, Any]:
        ...
        try:
                ...
                if metrics_config:
                    ...
                    for connector_type, config in metrics_config.items():
                        ...
                        if config.get("enabled", False):
                            ...
                            required_fields = self._get_required_fields_for_connector(connector_type)
            ...
            result["details"]["connector_types_found"] = list(result["details"]["connector_types_found"])
