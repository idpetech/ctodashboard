...
class DatabaseAdapter(ABC):
    ...
    def encrypt_data(self, data: Dict[str, Any]) -> bytes:
        ...
        try:
            ...
            logger.error("Encryption failed", extra={"operation": "encrypt_data", "error": str(e)})
            raise
    ...
    def decrypt_data(self, encrypted_data: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("Decryption failed", extra={"operation": "decrypt_data", "error": str(e)})
            raise
    ...
    def connect(self) -> bool:
        try:
            ...
            logger.info(
                ...
                extra={"operation": "db_connect", "adapter": "sqlite", "path": db_path},
            )
            return True
        except Exception as e:
            logger.error(
                "SQLite connection failed",
                extra={"operation": "db_connect", "adapter": "sqlite", "error": str(e)},
            )
            return False
...
class PostgreSQLAdapter(DatabaseAdapter):
    ...
    def __init__(self, connection_config: Dict[str, Any], encryption_key: Fernet):
        ...
        try:
            ...
            raise ImportError(
                "psycopg2 required for PostgreSQL adapter. Install with: pip install psycopg2-binary"
            )
    ...
    def connect(self) -> bool:
        try:
            ...
            logger.error(
                ...
                extra={"operation": "db_connect", "adapter": "postgresql", "error": str(e)},
            )
            return False
    ...
    def create_tables(self):
        ...
        from .canonical_schema import SCHEMA_NAME, apply_canonical_schema
    ...
    def execute_update(self, query: str, params: Tuple = None) -> int:
        try:
            ...
            logger.error(
                "PostgreSQL update execution failed",
                extra={
                    "operation": "execute_update",
                    "query": query[:100] + "..." if len(query) > 100 else query,
                    "error": str(e),
...
def create_database_adapter(
    db_type: str, connection_config: Dict[str, Any], encryption_key: Fernet
) -> DatabaseAdapter:
