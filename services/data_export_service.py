...
class DataExportService:
    ...
    def __init__(self):
        ...
        logger.info(
            "DataExportService initialized with singleton database instance",
            extra={"operation": "service_init", "service": "data_export", "singleton_used": True},
        )

    def export_workspace_data(
        self, workspace_id: str, format: str = "json", include_assignments: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def export_assignment_data(
        self, workspace_id: str, assignment_id: str, format: str = "json"
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if not assignment:
                raise ValueError(
                    f"Assignment {assignment_id} not found in workspace {workspace_id}"
                )
            ...
            export_data = {
                ...
                "assignment": {
                    ...
                    "metrics_config": self._sanitize_metrics_config(
                        assignment.get("metrics_config")
                    ),
                },
                "connector_types": self._get_connector_types_for_assignment(
    ...
    def _get_connector_types_for_assignment(
        self, workspace_id: str, assignment_id: str
    ) -> List[str]:
    ...
    def _export_to_csv(self, export_data: Dict[str, Any], file_path: Path):
        ...
        with open(file_path, "w", newline="") as csvfile:
            if export_data.get("assignments"):
                ...
                writer.writerow(
                    [
                        export_data["export_metadata"]["workspace_id"],
                        export_data["export_metadata"]["export_timestamp"],
                    ]
                )
