...
def log_function_call(func_name: str, **kwargs):
    ...
    logger.info(
        ...
        extra={"function": func_name, "operation": "function_call", **kwargs},
    )


def log_api_request(
    method: str, path: str, status_code: int = None, duration_ms: float = None, **kwargs
):
    """
