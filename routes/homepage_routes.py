...
def homepage():
    ...
    try:
        ...
        fallback_content = {
            ...
            "solution": {"title": "Attention Engine", "description": "AI-powered system for your development pipeline", "workflow": [
            ...
            "features": {"title": "Complete CTO Intelligence", "subtitle": "Connect your tech stack", "feature_list": [
                {"icon": "github", "title": "GitHub Insights", "description": "Code velocity", "details": ["Repository health"]},
                {"icon": "jira", "title": "Jira Insights", "description": "Sprint health", "details": ["Issue tracking"]},
                {"icon": "deploy", "title": "Deployment Monitoring", "description": "Uptime tracking", "details": ["Error monitoring"]},
                {"icon": "strategic", "title": "Strategic Tracking", "description": "Business KPIs", "details": ["Cost optimization"]}
            ]},
            "daily_brief": {"title": "Daily Briefing", "subtitle": "Essential insights", "date": "Today", "brief_items": [
